...
public:
  ...
  //it is a getter for points vector.
  vector<Point> getPoints();

  // it removes point from the given index
  void removeAtIndex(int index); // implement

  // adds point to the given index
  void addAtIndex(Point &newpt, int index); // implement

  // gets a point from the list at index i
  Point &getPointAt(unsigned int i);

  Point &AddPointAt(Point &newPt, int i);
